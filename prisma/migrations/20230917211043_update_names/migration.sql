...
CREATE TABLE "Product" (
    ...
    "product_image" TEXT NOT NULL DEFAULT 'https://via.placeholder.com/150',
...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_orderDetailId_fkey" FOREIGN KEY ("orderDetailId") REFERENCES "OrderDetail"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "OrderDetail" ADD CONSTRAINT "OrderDetail_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "Order"("id") ON DELETE SET NULL ON UPDATE CASCADE;
